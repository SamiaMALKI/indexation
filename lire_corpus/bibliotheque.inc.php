...
function caractHTML2ASCII($html) {
	//$texteAscii = htmlspecialchars_decode ( htmlentities ( $html, ENT_NOQUOTES, 'UTF-8' ) );
	/*$texteAscii = html_entity_decode ( htmlentities ( $html, ENT_NOQUOTES, 'UTF-8' ) );
	$texteAscii = utf8_decode($texteAscii);
